...
export const ROUTES: RouteInfo[] = [
   // { path: '/dashboard', title: 'Doctor Dashboard',  icon: 'dashboard', class: '' },
    ...
    { path: '/patients', title: 'Patients',  icon:'library_books', class: '' },
   // { path: '/icons', title: 'Reports',  icon:'bubble_chart', class: '' },
    { path: '/drugs', title: 'Drugs',  icon:'location_on', class: '' },
...
export const PATIENT_ROUTES: RouteInfo[] = [
 // { path: '/dashboard', title: 'Patient Dashboard',  icon: 'dashboard', class: '' },
  { path: '/user-profile', title: 'User Profile',  icon:'person', class: '' },
  { path: '/appointments', title: 'Appointments',  icon:'content_paste', class: '' },
  { path: '/patients', title: 'Reports',  icon:'library_books', class: '' }
